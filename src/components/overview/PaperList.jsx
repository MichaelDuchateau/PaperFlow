    ...
    <tr className="group border-b border-gray-800/60 hover:bg-gray-900/60 transition-colors">
      ...
      <td className="px-3 py-3 w-32">
        <div className="flex items-center gap-0.5">
          ...
          {/* Flashcards */}
          <ActionIcon title="View flashcards" active={!!paper.flashcards_path} onClick={() => paper.flashcards_path && navigate(`/flashcards/${paper.id}`)}>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
          ...
          {/* Mind map */}
          <ActionIcon title="View mind map" active={!!paper.mindmap_path} onClick={() => paper.mindmap_path && navigate(`/reader/${paper.id}?tab=mindmap`)}>
            <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5}
